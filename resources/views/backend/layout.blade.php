    ...
    <div class="wrapper">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        Burak BİLİCİ - Bilgisayar Mühendisi
                                    </p>
                                </li>
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="#"><i class="fa fa-check-square-o "></i> Site Ayarları</a></li>
        ...
        <footer class="main-footer">
            ...
            <div class="pull-right hidden-xs">
                <a href="http://karisik.site">Burak BİLİCİ</a>
            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; 2019 <a href="#">Medicana</a>.</strong> All rights reserved.
        </footer>
