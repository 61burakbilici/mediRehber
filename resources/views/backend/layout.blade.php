  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('kullanicilar.Index')}}"><i class="fa fa-user-circle-o"></i> <span>Kullacılar</span></a></li>
        <li><a href="{{route('hastaneler.Index')}}"><i class="fa fa-hospital-o"></i> <span>Hastaneler</span></a></li>
        <li class="treeview">
